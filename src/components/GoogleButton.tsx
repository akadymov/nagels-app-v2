 ...
 *  - official multicolor G mark (inline SVG via data URI)
...
import { Pressable, Image, Text, StyleSheet, type ViewStyle } from 'react-native';
...
export const GoogleButton: React.FC<GoogleButtonProps> = ({
  onPress, label, testID, disabled, style,
}) => {
  ...
  return (
    ...
    >
      <Image source={{ uri: GOOGLE_G_URI }} style={styles.logo} />
